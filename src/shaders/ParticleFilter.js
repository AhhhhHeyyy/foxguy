...
import fragSrc from './glsl/particle.frag?raw'

export default class ParticleFilter extends Filter {
  constructor() {
  ...
  update(state) {
    ...
    this.resources.uniforms.uniforms.uBlink = state.blink ? 1.0 : 0.0
